...
#
# Created: Mon Apr 27 16:25:03 2015
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.labelGenerating.setGeometry(QtCore.QRect(10, 876, 781, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setItalic(True)
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(640, 180, 581, 48))
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(640, 240, 581, 48))
        self.layoutWidget_2.setObjectName(_fromUtf8("layoutWidget_2"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.layoutWidget_2)
        self.verticalLayout_2.setMargin(0)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.labelInfoLongNoSpecial = QtGui.QLabel(self.layoutWidget_2)
        ...
        self.lineEditPasswordLongNoSpecial = QtGui.QLineEdit(self.layoutWidget_2)
        ...
        self.pushButtonClipboardLongNoSpecial = QtGui.QPushButton(self.layoutWidget_2)
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(640, 300, 581, 48))
        self.layoutWidget_3.setObjectName(_fromUtf8("layoutWidget_3"))
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.layoutWidget_3)
        self.verticalLayout_3.setMargin(0)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.labelInfoShort = QtGui.QLabel(self.layoutWidget_3)
        ...
        self.lineEditPasswordShort = QtGui.QLineEdit(self.layoutWidget_3)
        ...
        self.pushButtonClipboardShort = QtGui.QPushButton(self.layoutWidget_3)
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(640, 360, 581, 48))
        ...
        self.labelInfoShortNoSpecial = QtGui.QLabel(self.layoutWidget_4)
        ...
        self.lineEditPasswordShortNoSpecial = QtGui.QLineEdit(self.layoutWidget_4)
        ...
        self.pushButtonClipboardShortNoSpecial = QtGui.QPushButton(self.layoutWidget_4)
        ...
        self.groupBoxPasswords.setGeometry(QtCore.QRect(630, 100, 601, 341))
        self.groupBoxPasswords.setObjectName(_fromUtf8("groupBoxPasswords"))
        mainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(mainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1244, 19))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.labelInfoLong.setText(_translate("mainWindow", "TextLabel", None))
        self.pushButtonClipboardLong.setText(_translate("mainWindow", "Copy to Clipboard", None))
        self.labelInfoLongNoSpecial.setText(_translate("mainWindow", "TextLabel", None))
        self.pushButtonClipboardLongNoSpecial.setText(_translate("mainWindow", "Copy to Clipboard", None))
        self.labelInfoShort.setText(_translate("mainWindow", "TextLabel", None))
        self.pushButtonClipboardShort.setText(_translate("mainWindow", "Copy to Clipboard", None))
        self.labelInfoShortNoSpecial.setText(_translate("mainWindow", "TextLabel", None))
